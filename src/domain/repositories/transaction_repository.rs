...
pub trait TransactionRepository: Send + Sync {
    ...
    async fn find_by_account(&self, account_id: Uuid, limit: i64, offset: i64) -> AppResult<Vec<Transaction>>;
    ...
    async fn execute_credit(&self, transaction: &Transaction, account_id: Uuid, amount: i64) -> AppResult<Transaction>;
    async fn execute_debit(&self, transaction: &Transaction, account_id: Uuid, amount: i64) -> AppResult<Transaction>;
}
